...
class _AboutViewState extends State<AboutView> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar.secondaryAppBar(title: 'About', context: context),
      body: Consumer<AboutController>(
        builder: (context, aboutController, child) {
          return aboutController.isLoading ? Center(child: Lottie.asset(Strings.lottieLoadAnim, width: 80, height: 80)): ListView(
